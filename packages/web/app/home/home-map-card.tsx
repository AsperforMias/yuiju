  ...
  const mapStage = (variant: "default" | "zoom") => (
    <section
      className={cn(
        ...
        "before:[background-image:linear-gradient(rgba(217,230,245,0.55)_1px,transparent_1px),linear-gradient(90deg,rgba(217,230,245,0.55)_1px,transparent_1px)]",
        "before:[background-size:56px_56px]",
