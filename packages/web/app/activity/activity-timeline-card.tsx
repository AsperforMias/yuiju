...
export function ActivityTimelineCard({ events, selectedId, onSelect }: ActivityTimelineCardProps) {
  ...
  const filteredEvents = useMemo(() => {
    ...
    if (timeRange === 'today') {
      ...
      next = next.filter(item => dayjs(item.happenedAt).isAfter(from) || dayjs(item.happenedAt).isSame(from));
    }
      ...
      <div className="p-3.5 grid gap-3">
        ...
        <div className="grid grid-cols-4 gap-2.5 max-[760px]:grid-cols-2 max-[520px]:grid-cols-1">
          <div className="grid gap-1.5">
            ...
            <Select value={timeRange} onValueChange={(value: string) => setTimeRange(value as TimeRangeOption)}>
          ...
          <div className="grid gap-[6px]">
            ...
            <Select value={trigger} onValueChange={(value: string) => setTrigger(value as TriggerFilter)}>
          ...
          <div className="grid gap-[6px]">
            ...
            <Select value={episodeType} onValueChange={(value: string) => setEpisodeType(value as EpisodeTypeFilter)}>
